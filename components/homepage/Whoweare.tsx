...
const Whoweare = ({WhoWeAreData}: WhoWeAreSectionProps) => {
 ...
 const { heading, sub_heading, cta_text, cta_link, description, image } = WhoWeAreData;
                ...
                <div className='container mx-auto px-4 py-12 md:py-15'>
                    <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-10 md:gap-6 items-center'>
                        ...
                        <div className='md:col-span-7 md:pl-0 lg:pl-10'>
                            ...
                            <h2 className='text-2xl md:text-3xl lg:text-4xl text-white font-semibold capitalize mb-4 leading-12 custom-heading-color-light' dangerouslySetInnerHTML={{ __html: heading ?? '' }}/>
