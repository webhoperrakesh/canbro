        ...
        <section className='bg-[#F6F6F6]' id='our-commitment'>
            <div className='container mx-auto px-4 py-8'>
                <div className='flex flex-col justify-center items-center gap-4'>
                    ...
                    {heading &&
                        <h2 className='text-2xl md:text-3xl lg:text-4xl font-semibold text-[#38A0A7] capitalize mb-4 custom-heading-color-blue' dangerouslySetInnerHTML={{ __html: heading }} />
                    }
                            ...
                            {commitmentItems.slice(0, 4).map((item: any, index: number) => (
                                ...
                                >
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-gray-800 font-semibold text-2xl capitalize">{item.sub_heading}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
