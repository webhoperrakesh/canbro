...
const HeroSection = () => {
    return (
        <section className="relative h-auto md:h-[80vh] lg:h-[80vh] overflow-hidden bg-[url(/images/hero-bg.png)] bg-auto bg-center bg-no-repeat" style={{ backgroundSize: "100% 100%" }}>
