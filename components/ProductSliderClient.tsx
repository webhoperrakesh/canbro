...
const ProductSliderClient = ({ products }: ProductsProps) => {
                ...
                >
                    <div className="relative p-4">
                        <Image
                            ...
                            width={200}
                            height={280}
                            className="w-32 lg:w-48 rounded-2xl h-auto object-contain drop-shadow-lg group-hover:scale-105 transition-transform duration-300"
                            draggable={false}
                        />
                ...
                <div className="relative flex-1">
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden lg:overflow-visible shadow-xl transition-all duration-500">
                        <div className="flex flex-col lg:flex-row">
                            ...
                            {/* Content Section */}
                            <div
                                className={`lg:w-1/2 bg-orange-500 text-white p-6 md:p-8 lg:p-12 flex flex-col justify-center relative overflow-hidden lg:rounded-tr-2xl lg:rounded-br-2xl`}
                            >
