        ...
        <div className='bg-[url(/images/certificate-bg.png)] bg-center bg-no-repeat bg-cover lg:bg-[length:100%_100%]' id='our-certificate'>
          <div className='container mx-auto px-4 py-12 md:py-15'>
            <div className='flex flex-col justify-center items-center gap-4'>
              <h2 className='text-center text-2xl md:text-3xl lg:text-4xl text-white font-semibold capitalize leading-12 custom-heading-color-light' dangerouslySetInnerHTML={{ __html: pageData.customFields[1].heading ?? '' }}/>
        ...
        <div className='container mx-auto px-4 py-12 md:py-15'>
          <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-10 md:gap-6 items-center'>
            ...
            <div className='md:col-span-7 md:pl-0 lg:pl-10'>
              ...
              <h2 className='text-2xl md:text-3xl lg:text-4xl font-semibold text-[#38A0A7] capitalize mb-4 custom-heading-color-blue' dangerouslySetInnerHTML={{ __html: pageData.customFields[2].heading ?? '' }}/>
